...
Status: **active; v0.1.1 CI receipt revoked and v0.1.2 compatibility candidate in verification; private consumer cutover open**
...
| ID | Oracle | Status |
| --- | --- | --- |
| ENG01 | Independent public package has license/docs/build/test/typed API | PASS — public repository and immutable v0.1.0 tag at commit `4022fa3`; v0.1.2 compatibility source verification recorded in the E3 contract |
...
| ENG08 | Private service consumes released engine and duplicates are deleted | PARTIAL — private source consumer migration exists under its own contract; immutable green v0.1.2 pin, production package proof, and duplicate-authority closure remain open |
...
| ENG12 | Public release/tag/package/docs/security evidence | PARTIAL — public v0.1.0 source/tag/release/docs and CI exist; immutable v0.1.1 failed its typing CI and is preserved as evidence; v0.1.2 tag/checksum/CI, signing, and final security/reproducibility closure remain open |
